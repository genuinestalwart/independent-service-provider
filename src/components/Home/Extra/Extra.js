...
const Extra = () => {
    return (
        <section className='md:flex px-8 pb-12 md:p-16'>
            <div className='md:px-8 md:w-3/5'><img className='rounded-xl w-full' src={myself} alt="who am i" /></div>

            <div className='md:px-8 md:py-20 md:w-2/5'>
