...
const About = () => {
    return (
        <section style={{ backgroundImage: `url(${aboutBG})` }} className="bg-no-repeat bg-cover md:flex justify-center">
            <div className='md:my-8 p-8 md:p-0 text-center text-slate-700 md:w-2/5'>
                ...
                <h4 className='font-semibold mt-[0.5rem] text-lg'>Wish me luck! 😉</h4>
            </div>
        </section>
    );
};
